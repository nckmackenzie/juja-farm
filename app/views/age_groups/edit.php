        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="card bg-light">
                    <div class="card-header">Edit Age Group</div>
                    <div class="card-body">
                        <form action="<?php echo URLROOT;?>/age_groups/update" method="post">
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  id="name" name="name"
                                               ...
                                               value="<?php echo (!empty($data['name'])) ?  $data['name'] : strtoupper($data['agegroup']->ageGroupName)?>"
                                               autocomplete="off">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="number"  id="from" name="from"
                                               ...
                                               value="<?php echo (!empty($data['from'])) ? $data['from'] : $data['agegroup']->fromAge?>"
                                               autocomplete="off">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        ...
                                        <input type="number"  id="to" name="to"
                                               ...
                                               value="<?php echo (!empty($data['to'])) ? $data['to'] : $data['agegroup']->toAge?>"
                                               autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <input type="hidden" name="id" value="<?php echo $data['agegroup']->ID;?>">
                                </div>
                            </div>
                        </form>
                    </div>
