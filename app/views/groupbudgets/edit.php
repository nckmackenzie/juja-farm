  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
             <a href="<?php echo URLROOT;?>/groupbudgets" class="btn btn-dark btn-sm mt-2"><i class="fas fa-backward"></i> Back</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm" 
                                           value="<?php echo $data['header']->groupName;?>"
                                           readonly>
                                </div>
                            </div>
                        </div>
...
<script>
    $(function(){
        function edit_data(id,amount){
            $.ajax({
                url : '<?php echo URLROOT;?>/groupbudgets/update',
                method : 'POST',
