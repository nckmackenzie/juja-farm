        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="card card-body bg-light mt-5">
                    <h5>Edit Group</h5>
                <hr>
                    <form action="<?php echo URLROOT;?>/groups/update" method="post">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <?php echo (!empty($data['name_err'])) ? 'is-invalid' : ''?>"
                                        id="groupName" 
                                        value="<?php echo strtoupper($data['groups']->groupName);?>"
                                        name="groupname"
                                        placeholder="Enter Group Name eg PCMF"
                                        autocomplete="off">
                                    <span class="invalid-feedback"><?php echo $data['name_err'];?></span>
                                    <input type="hidden" name="id" value="<?php echo $data['groups']->ID;?>">
                                </div>    
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-check">
                                    ...
                                    <?php echo ($data['groups']->active) == 1 ? 'checked' : ''?>>
