<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent"
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview custom-font">
                <li class="nav-item">
                    <a href="<?php echo URLROOT;?>/congregations" class="nav-link">
                        <p>Congregations</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo URLROOT;?>/parishofficials" class="nav-link">
                        <p>Parish Officials</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo URLROOT;?>/elders" class="nav-link">
                        <p>Elders</p>
                    </a>
                </li>
                <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview custom-font">
                ...
                <li class="nav-item">
                    <a href="<?php echo URLROOT;?>/parishreports/banking" class="nav-link">
                        <p>Banking Reports</p>
                    </a>
                </li>
                <li class="nav-item">
