  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-2">
                <label for="">Family Count:</label>
                <input type="text" 
                       class="form-control form-control-sm" 
                       id="count" 
                       value="<?php echo $data['familycount'];?>"
                       readonly>
            </div>
        </div>
      </div><!-- /.container-fluid -->
...
<script>
    $(function(){
        ...
        $('#district').change(function(){
            ...
            $.ajax({
                url : '<?php echo URLROOT;?>/reports/getfamilycountbydistrict',
                method : 'POST',
        ...
        $('#preview').click(function(){
            ...
            $.ajax({
                url : '<?php echo URLROOT;?>/reports/familyreport',
                method : 'POST',
                data : {district : district},
                success : function(html){
                    // console.log(html);
