        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="card card-body bg-light mt-5">
                    ...
                    <hr>
                    <form action="<?php echo URLROOT;?>/services/createinfo" method="post">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo (!empty($data['service_err'])) ? 'is-invalid': ''?>">
                                        <?php foreach($data['services'] as $service) :?>
                                            ...
                                            <?php selectdCheck($data['service'],$service->ID );?>>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-sm"
                                    value="<?php echo $data['attendance'];?>"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    value="<?php echo $data['envelopepledge'];?>"
