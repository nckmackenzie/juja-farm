        ...
        <section class="invoice">
            ...
            <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                    TO
                    <address>
                        <strong><?php echo $data['supplierinfo']->supplierName;?></strong>
                        <br>Address: <?php echo $data['supplierinfo']->address;?>
                        <br>Phone: <?php echo $data['supplierinfo']->contact;?>
                        <br>Email: <?php echo $data['supplierinfo']->email;?>
                        <br>P.I.N: <?php echo $data['supplierinfo']->pin;?>
                    </address>
                </div><!-- /.col -->
                <div class="col-sm-4 invoice-col">
