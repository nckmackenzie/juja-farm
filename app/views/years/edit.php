        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="card bg-light">
                    ...
                    <div class="card-body">
                        <form action="<?php echo URLROOT;?>/years/update" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        value="<?php echo (!empty($data['yearname'])) ? $data['yearname'] : strtoupper($data['year']->yearName)?>"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="startdate" id="startdate"
                                               ...
                                               value="<?php echo $data['year']->startDate; ?>" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="enddate" id="enddate"
                                               ...
                                               value="<?php echo $data['year']->endDate; ?>" readonly>
                            ...
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <input type="hidden" name="id" value="<?php echo $data['year']->ID;?>">
                                </div>
                            </div>
                        </form>
                    </div>
